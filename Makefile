...
repo-init:
	...
	case "$$choice" in \
		yes|Y|y) \
			echo -e "\033[31mPlease enter initial commit message: \033[0m "; \
			read -r commitMsg; \
...
dcgen:
	...
	@echo "      - $(COMPOSE_VOL1):/var/ssl/cert.pem" >> ./src/docker-compose.yml
	@echo "      - $(COMPOSE_VOL2):/var/ssl/key.pem" >> ./src/docker-compose.yml
